...
export default async function NewExpensePage({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <h2 className="mb-6 mt-2 text-lg font-semibold text-slate-900">{t(locale, "expenseForm.addTitle")}</h2>
      <ExpenseForm
